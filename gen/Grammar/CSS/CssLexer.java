// Generated from src/Grammar/CSS/CssLexer.g4 by ANTLR 4.13.2
package Grammar.CSS;
...
public class CssLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IDENT_START", "IDENT_CHAR", "NMSTART", "NMCHAR", "IMPORTANT", "URL", 
			"AT_RULE", "AND", "NOT", "VAR", "STRING", "LBRACE", "RBRACE", "LPAREN", 
			"RPAREN", "COMMA", "SEMICOLON", "COLON", "DOT", "HASH", "GREATER", "PLUS", 
			"TILDE", "DOUBLE_COLON", "SLASH", "EQUALS", "MINUS", "SQUARE_OPEN", "SQUARE_CLOSE", 
			"STAR", "TILDE_EQUALS", "PIPE_EQUALS", "CARET_EQUALS", "DOLLAR_EQUALS", 
			"STAR_EQUALS", "QUESTION", "NUMBER", "IDENT", "WS", "COMMENT"
		};
	}
